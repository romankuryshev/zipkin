...
export const SpanDetailDrawer = ({
  ...
  // Extract statistics directly from span object
  const spanStats = span.statistics
    ? {
        medianDuration: span.statistics.medianDuration,
        averageDuration: span.statistics.averageDuration,
        p50: span.statistics.p50,
        p95: span.statistics.p95,
        p99: span.statistics.p99,
        successCount: span.statistics.successCount,
        errorCount: span.statistics.errorCount,
        totalCount: span.statistics.totalCount,
      }
    : null;
